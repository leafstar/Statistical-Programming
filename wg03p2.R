...
## For that purpose we split the population by 4 categories 1) Susceptible 2) Exposed 3) Infective and 4) Recovered and do the following steps:
  ...
  ## Step (1):Show daily infection trajectories for three groups 1) Whole population 2) Cautious group - 10% of the population with the lowest probability transmission
  ## rates and 3)Random sample of 0.1% of the population n=5.5e6.
...
points(log(epi$I2),col=4,cex=0.1);points(log(epi$I3),col=2,cex=0.1)                   
legend(0, 15, legend=c("whole population", "cautious group", "random 0.1% group"),
       col=c("black", "blue","red"), lty=1:2, cex=0.8)            ## E (blue)  I (red) S black;
