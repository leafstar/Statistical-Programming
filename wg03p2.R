...
## The Covid pandemic is an ongoing global pandemic already two years. One of the main features 
## of the Covid-19 epidemic in the UK and generally in the world is that the estimates of the number
## of new cases per day are not always based on properly sampled statistical surveys. Thus, estimates are under question. 
## The main purpose of this assignment is to show what the daily infection trajectories look like for
## the population with the lowest individual transmission probabilities, and how they compare to the infection 
## trajectories for the whole population in the UK. 
## For that purpose we split the population by 4 categories 1) Susceptible 2) Exposed 3) Infective 
## and 4) Recovered and do the following steps:
## (1) Show daily infection trajectories for three groups 1) Whole population 2) Cautious group - 10% of 
## the population with the lowest probability transmissionrates and 3) Random sample of 0.1% of the population n=5.5e6.
## (2) Produce a plot showing how the daily infection trajectories compare between the whole population, 
## the ‘cautious 10%’ and the 0.1% random sample. 
## (3) Run 10 replicate simulations for each groups.
## (4) Produce three plots for 10 replicate simulations showing daily infection trajectories for 
## each groups and their variability.


## Step (1):Show daily infection trajectories for three groups 1) Whole population 2) Cautious group - 10%
## of the population with the lowest probability transmission
## rates and 3)Random sample of 0.1% of the population n=5.5e6.
